...
def get_loader_train(path_root, batchsize,collate_fn, shuffle=True, num_workers=4, pin_memory=True):
...
def get_loader_test(path_root, batchsize,collate_fn, shuffle=True, num_workers=4, pin_memory=True):
